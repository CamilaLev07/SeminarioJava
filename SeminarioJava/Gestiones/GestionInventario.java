...
public void modificarDevolucion(int idDevolucion, Scanner scanner) {
    Devolucion devolucion = buscarDevolucionPorId(idDevolucion); // Implementa este método para buscar la devolución por ID
    if (devolucion != null) {
        ...
        if (!nuevaFecha.isEmpty()) {
            devolucion.setFecha(Date.valueOf(nuevaFecha)); // Asegúrate de que tengas un método setFecha en la clase Devolucion
        }
        ...
        if (nuevoIdProducto != 0) {
            devolucion.setIdProducto(nuevoIdProducto); // Asegúrate de que tengas un método setIdProducto en la clase Devolucion
        }
        ...
        if (!nuevoMotivo.isEmpty()) {
            devolucion.setMotivo(nuevoMotivo); // Asegúrate de que tengas un método setMotivo en la clase Devolucion
        }
...
public void modificarProveedor(int idProveedor, Scanner scanner) {
    Proveedor proveedor = buscarProveedorPorId(idProveedor); // Implementa este método para buscar el proveedor por ID
    if (proveedor != null) {
